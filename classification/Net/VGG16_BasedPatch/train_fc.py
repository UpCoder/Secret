...
from classification.dataset.PatchDataSet import PatchDataSet
import numpy as np
import gc
...
class train:
    def __init__(self, load_model_path, save_model_path):
        ...
        self.dataset = PatchDataSet(config, self.threshold, self.up_threshold, self.down_threhold, self.using_border)
    ...
    def start_train(self):
        ...
        with tf.Session() as sess:
            ...
            if self.load_model_path:
                ...
                print 'load model succssful', self.load_model_path
            ...
            for i in range(self.iterator_number):
                if i % 500 == 0 and i != 0:
                    print 'model save successful', self.save_model_path
                    saver.save(
                        sess,
...
if __name__ == '__main__':
    my_train = train(
        ...
        save_model_path='/home/give/PycharmProjects/StomachCanner/classification/Net/VGG16_BasedPatch/model/0.8_0.2_2'
    )
