...
def do_conv(name, input_tensor, out_channel, ksize, stride=[1, 1, 1, 1],
            is_pretrain=True, dropout=False, reuse=False, batch_normalization=True):
    input_channel = input_tensor.get_shape()[-1]
...
def calculate_loss(logits, labels, is_regression=False, arg_index=1):
    '''Compute loss
    Args:
